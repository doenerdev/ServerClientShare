...
namespace ServerClientShare.PeristenceMessages
{
    public class ClientSentActionMessage : PersitenceMessage<ClientSentActionMessage>
    {
        ...
        public ClientSentActionMessage(string actionName, string playerName, string actionJson)
        {
            MessageType = NetworkMessageType.GameActionPerformed;
        ...
        public new static ClientSentActionMessage FromMessageArguments(Message message, ref uint offset)
        {
            ...
            var dto = new ClientSentActionMessage(actionName, playerName, actionJson) {Id = id};
            return dto;
        }
    }
}
