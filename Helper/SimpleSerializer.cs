...
namespace ServerClientShare.Helper
{
	public class SimpleSerializer
	{
		...
		public byte[] Serialize(object obj)
		{
			...
			throw new Exception("[SimpleSerializer] Unsupported Type: " + obj.GetType());
		}
		...
		public object Deserialize(byte[] data, Type t)
		{
			...
			throw new Exception("[SimpleSerializer] Unsupported Type: " + t);
		}
		...
		public byte[] SerializeArray(object obj)
		{
			...
			if (f == null) throw new Exception("[SimpleSerializer] Unsupported Array type.");
		...
		public object DeserializeEnum(byte[] data, Type t)
		{
			...
			throw new Exception("[SimpleSerializer] Could not Deserialize Enum.");
		}
